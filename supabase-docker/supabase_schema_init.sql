...
CREATE TABLE IF NOT EXISTS public.rule_evaluation_audit_log (
    id bigint NOT NULL DEFAULT nextval('rule_evaluation_audit_log_id_seq'::regclass) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS public.rule_deficit_recommendations (
    id bigint NOT NULL DEFAULT nextval('rule_deficit_recommendations_id_seq'::regclass) PRIMARY KEY,
    session_id character varying(255),
    turn_index integer,
    user_prompt text,
    thinking_process jsonb,
